<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Registro/Registro.Master" AutoEventWireup="true" CodeBehind="DetalleVisitanteSalida.aspx.cs" Inherits="WebTotalControl.Views.Registro.DetalleVisitanteSalida" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <h1 class="col-xs-12">Salida Visitante</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-6 profile-info">
            <p>Nombre completo: Gloria Valdez</p>
            <p>Número de identificación: 85638965</p>
            <p>Dependencia a visitar: Aula 202</p>
        </div>
